...
def implement_bicluster_spectralcoclustering(training_set: TrainingSet, save_to_file: bool = False, use_interpolation: bool = False):
    ...
    plot_biclustering(data, model, training_set, save_to_file=save_to_file, feature_names=avg_df.index.to_numpy(),
...
def plot_biclustering(data_raw: np.ndarray, model: sklearn.base.BiclusterMixin, training_set: TrainingSet,
                      save_to_file: bool = False, used_interpolation: bool = False, feature_names: np.ndarray = None):
    """
