...
def display_table(selected_set: TrainingSet):  # TODO: Aufgabe Aline: calculate our own general info per dataset (amount of patients etc) - not just import of an image
...
class LandingPage:
    ...
    def __init__(self):
        ...
        loaded_training_set: TrainingSet = TrainingSet.get_training_set(name=selected_set)
        display_table(loaded_training_set)
        write_text_2()
